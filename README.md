...
<div align="center">
  ...
  <h3 align="center">Raman Kumar Portfolio</h3>

  <p align="center">
    A Technology agency fullstack website built in React, MUI, Bootstrap, and Node.js.
    <br />
    <strong>Written by me (Raman Kumar) - Not an AI.</strong>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/raman-kumar/portfolio-project
   ```
